...
- [ ] 立即运行 v11 epoch1；必须再次精确复现 v6/v9/v10 epoch1 后才允许 resume epoch2。epoch2 后验证 encoder delta=`0`、decoder feature delta=`0`、BN buffer delta=`0`、仅 final head delta!=0，并完成 `liver_7/liver_8` detailed validation / diagnostics / dynamics
