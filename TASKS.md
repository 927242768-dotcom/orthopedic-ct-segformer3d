...
- [ ] 从 v11 `checkpoint/last.pt` resume 到总 epoch2；验证 encoder delta=`0`、decoder feature delta=`0`、BN buffer delta=`0`、仅 final head delta!=0，并完成 `liver_7/liver_8` detailed validation / diagnostics / dynamics
